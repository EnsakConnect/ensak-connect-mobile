...
@HiltViewModel
public class RecommendedOffersViewModel extends ViewModel {
    ...
    @Inject
    public RecommendedOffersViewModel(FeedRepository feedRepository, LikeRepository likeRepository) {
